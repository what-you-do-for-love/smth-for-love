...
export default function DashboardPage() {
    ...
    const displayName = getCookie('name') || getUserName() || t('common.friendFallback');
            ...
            <div className="bg-white p-5 sm:p-8 rounded-3xl border border-gray-100 shadow-xl shadow-pink-50/50">
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    >
                        ...
                        {t('dashboard.memoriesCta')}
                    </Link>
                </div>
            </div>

            {/* Partner hero — sits at the top, right under the welcome banner */}
            <PartnerHero />

            {/* Snapshot stats */}
            <DashboardStats />

            {/* Relationship section — incoming requests + (optional) find-by-code */}
            {/* <div className="bg-white p-5 sm:p-8 rounded-3xl border border-gray-100 shadow-xl shadow-pink-50/50">
                <RelationshipSection />
            </div> */}
